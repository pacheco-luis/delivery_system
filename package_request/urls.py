...
urlpatterns = [
    ...
    path('delete_pickup_route/<id>/', views.delete_pickup_route, name = 'delete_pickup_route'),
    path('delete_deliver_route/<id>/', views.delete_deliver_route, name = 'delete_deliver_route'),
